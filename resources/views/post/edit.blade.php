										...
										<div class="gallery">
											...
											<div class="gallery-item" tabindex="0">
												...
												<div class="gallery-item-info">
													...
													<ul>
														<li class="gallery-item-likes"><span class="visually-hidden">Likes:</span><i class="fa fa-trash" aria-hidden="true"></i> <a class=" btn btn-primary" href="£">Edit</a></li>
														<li class="gallery-item-comments"><span class="visually-hidden">Comments:</span><i class="fas fa-comment" aria-hidden="true"><a class="btn btn-danger" href="n">delete</a></i> </li>
													</ul>
