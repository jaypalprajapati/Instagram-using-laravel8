                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Profile Image</strong>:</strong>
                                <input type="file" name="profile" class="form-control" value="{{old('name')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input  type="number" class="form-control " name="contect" value="{{ old('contect') }}" required autocomplete>
